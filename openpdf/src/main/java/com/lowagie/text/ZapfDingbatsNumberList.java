...
public class ZapfDingbatsNumberList extends List {
    ...
    public boolean add(Element o) {
        if (o instanceof ListItem) {
            ...
            switch (type) {
                case 0:
                    chunk.append(String.valueOf((char) (first + listOfListItems.size() + 171)));
                    break;
                case 1:
                    chunk.append(String.valueOf((char) (first + listOfListItems.size() + 181)));
                    break;
                case 2:
                    chunk.append(String.valueOf((char) (first + listOfListItems.size() + 191)));
                    break;
                default:
                    chunk.append(String.valueOf((char) (first + listOfListItems.size() + 201)));
            }
