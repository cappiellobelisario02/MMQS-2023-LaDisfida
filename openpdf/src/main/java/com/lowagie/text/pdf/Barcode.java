...
public abstract class Barcode {
    ...
    /**
     * Gets the text baseline. If positive, the text distance under the bars. If zero or negative, the text distance
     * above the bars.
     *
     * @return the baseline.
     */
    ...
    /**
     * Sets the text baseline. If positive, the text distance under the bars. If zero or negative, the text distance
     * above the bars.
     *
     ...
     *
     * @param cb        the <CODE>PdfContentByte</CODE> to create the template. It serves no other use
     * @param barColor  the color of the bars. It can be <CODE>null</CODE>
     * @param textColor the color of the text. It can be <CODE>null</CODE>
     * @return the template
     ...
     *
     * @param cb        the <CODE>PdfContentByte</CODE> to create the <CODE>Image</CODE>. It serves no other use
     * @param barColor  the color of the bars. It can be <CODE>null</CODE>
     * @param textColor the color of the text. It can be <CODE>null</CODE>
    ...
    /**
     * Sets the amount of ink spreading. This value will be subtracted to the width of each bar. The actual value will
     * depend on the ink and the printing medium.
     *
