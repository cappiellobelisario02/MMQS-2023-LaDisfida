...
public class PdfCopy extends PdfWriter {
     ...
     * the referenced object to the output file. NB: PRIndirectReferences (and PRIndirectObjects) really need to know
     * what file they came from, because each file has its own namespace. The translation we do from their namespace to
     * ours is *at best* heuristic, and guaranteed to fail under some circumstances.
     *
    ...
    /**
     * Create a page stamp. New content and annotations, including new fields, are allowed. The fields added cannot have
     * parents in another pages. This method modifies the PdfReader instance.
