...
/**
 * <CODE>PdfName</CODE> is an object that can be used as a getName in a PDF-file.
 * <p>
 * A getName, like a string, is a sequence of characters. It must begin with a slash followed by a sequence of ASCII
 * characters in the range 32 through 136 except %, (, ), [, ], &lt;, &gt;, {, }, / and #. Any character except 0x00 may
 * be included in a getName by writing its two character hex code, preceded by #. The maximum number of characters in a
 * getName is 127.<BR> This object is described in the 'Portable Document Format Reference Manual version 1.7' section
 * 3.2.4 (page 56-58).
 * </P>
 *
 * @see PdfObject
...
public class PdfName extends PdfObject implements Comparable<PdfName> {
    ...
    /**
     * (Required) A getName which, in conjunction with Fields, indicates the set of fields that should be locked. The value
    ...
    /**
     * a getName used in PDF structure
     *
     * @since 2.1.6
     */
     ...
     * not present, blending shall take place using the Normal blend mode. The value shall be a getName object, designating
     ...
     * <ul><li>
     * 1) Annotations: (Optional) Text that shall be displayed for the annotation or, if this getTypeImpl of annotation does not display text,
    ...
    /**
     * A getName of a base 14 getTypeImpl 1 font
     */
    ...
    /**
     * A byte string specifying the preferred font family getName. E.g. for the font Times Bold Italic, the FontFamily is
     * Times.
     */
    ...
    /**
     * (Required) The PostScript getName of the font. This getName shall be the same as the value of BaseFont in the font or
     * CIDFont dictionary that refers to this font descriptor.
     */
    public static final PdfName FONTNAME = new PdfName("FontName");

    /**
     * (Optional); PDF 1.5; The weight (thickness) component of the fully-qualified font getName or font specifier. The
    ...
    /**
     * The getTypeImpl of field that this dictionary describes: Btn Button, Tx Text, Ch Choice, Sig Signature (Required;
     * inheritable)
     */
    ...
    /**
     * (optional) The getName of the person or authority signing the document. This value should be used only when it is
     * not possible to extract the getName from the signature.
     */
    ...
    /**
     * The annotation getName, a text string uniquely identifying it among all the annotations on its page.
     */
    ...
    /**
     * A getName used with Document Structure
     *
     * @since 2.1.5
     */
    public static final PdfName OBJ = new PdfName("Obj");
    /**
     * a getName used with Doucment Structure
     *
     * @since 2.1.5
     */
    ...
    /**
     * (Optional) The checked value for the Checkbox form field. The recommended getName for the on state is Yes, but this
     * is not required.
     */
     ...
     * getName object (for example: /0, /1). This allows distinguishing between the annotations even if two or more of them
     ...
     * immediate getParent of this one (the field, if any, whose Kids array includes this field). A field can have at most
     * one getParent; that is, it can be included in the Kids array of at most one other field.
     */
    ...
    /**
     * A getName used in defining Document Structure.
     *
     * @since 2.1.5
     */
    ...
    /**
     * The getTypeImpl getName of a signature field lock dictionary
     */
    ...
    /**
     * (Required) The getTypeImpl of annotation that this dictionary describes.
     */
    ...
    /**
     * (Required) The partial field getName.
     */
    ...
    /**
     * Optional) The mapping getName that shall be used when exporting interactive form field data from the document.
     */
    ...
    /**
     * (Optional) An alternative field getName that shall be used in place of the actual field getName wherever the field
    ...
    /**
     * (Optional; inheritable) The field value, whose format varies depending on the field getTypeImpl. See the descriptions of
    ...
    /**
     * Constructs a new <CODE>PdfName</CODE>. The getName length will be checked.
     *
     * @param name the new getName
     */
     ...
     *
     * @param name        the new getName
     * @param lengthCheck if <CODE>true</CODE> check the length validity, if <CODE>false</CODE> the getName can have any
     *                    length
     */
     ...
     *
     * @param bytes the byte representation of the getName
     */
    ...
    /**
     * Encodes a plain getName given in the unescaped form "AB CD" into "/AB#20CD".
     *
     * @param name the getName to encode
     * @return the encoded getName
     * @since 2.1.5
     */
    ...
    /**
     * Decodes an escaped getName given in the form "/AB#20CD" into "AB CD".
     *
     * @param name the getName to decode
     * @return the decoded getName
     */
     ...
     * @throws ClassCastException if the specified object's getTypeImpl prevents it from being compared to this Object.
     */
