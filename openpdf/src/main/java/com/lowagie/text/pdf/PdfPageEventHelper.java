...
/**
 * Helps the use of <CODE>PdfPageEvent</CODE> by implementing all the interface methods. A class can extend
 * <CODE>PdfPageEventHelper</CODE> and only implement the needed methods.
 * <p>
