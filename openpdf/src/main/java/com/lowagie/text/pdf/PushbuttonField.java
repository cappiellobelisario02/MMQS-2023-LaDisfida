...
public class PushbuttonField extends BaseField {
    ...
    public PdfAppearance getAppearance() throws IOException, DocumentException {
        ...
        while (true) {
            switch (nlayout) {
                ...
                case LAYOUT_ICON_TOP_LABEL_BOTTOM:
                    ...
                    iconBox = new Rectangle(box.getLeft() + adj, textY + fsize, box.getRight() - adj,
                            box.getTop() - adj);
                    break;
        ...
        if (haveIcon) {
            ...
            float ypos =
                    iconBox.getBottom() + (iconBox.getHeight() - (boundingBoxHeight * icy)) * iconVerticalAdjustment;
            app.saveState();
            ...
            if (tp != null) {
                ...
                app.addTemplateReference(iconReference, PdfName.FRM, icx, 0, 0, icy, xpos - cox * icx,
                        ypos - coy * icy);
            }
            app.restoreState();
        }
