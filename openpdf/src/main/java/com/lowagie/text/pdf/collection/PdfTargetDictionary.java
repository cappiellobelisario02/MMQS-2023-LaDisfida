...
public class PdfTargetDictionary extends PdfDictionary {
    ...
    /**
     * If this dictionary refers to a child that is a file attachment added to a page, you need to specify the page
     * number (or use setFileAttachmentPagename to specify a named destination). Once you have specified the page, you
     * still need to specify the attachment using another method.
     *
    ...
    /**
     * If this dictionary refers to a child that is a file attachment added to a page, you need to specify the page with
     * setFileAttachmentPage or setFileAttachmentPageName, and then specify the index of the attachment added to this
     * page (or use setFileAttachmentName).
     *
