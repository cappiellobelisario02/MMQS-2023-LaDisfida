...
public class Word extends ParsedTextImpl {
     ...
     */
    Word(com.lowagie.text.pdf.parser.Word.Builder builder) {
    ...
    public static class Builder {
        ...
        public com.lowagie.text.pdf.parser.Word.Builder isCompleteWord(boolean isCompleteWord) {
            this.isCompleteWord = isCompleteWord;
            return this;
        }

        public com.lowagie.text.pdf.parser.Word.Builder breakBefore(boolean breakBefore) {
            this.breakBefore = breakBefore;
            return this;
        }

        public com.lowagie.text.pdf.parser.Word build() {
            return new com.lowagie.text.pdf.parser.Word(this);
        }
    }
}
