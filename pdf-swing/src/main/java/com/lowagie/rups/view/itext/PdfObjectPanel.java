...
public class PdfObjectPanel extends JPanel implements Observer {
    ...
    /**
     * The layout that will show the info about the PDF object that is being
     * analyzed.
     */
     ...
     */
    JTextArea bottom_info_text = new JTextArea();
    ...
    public PdfObjectPanel() {
        ...
        dict_scrollpane.setViewportView(entriesTable);
        add(dict_scrollpane, TABLE);

        // number / string / ...
        JScrollPane text_scrollpane = new JScrollPane();
        text_scrollpane.setViewportView(bottom_info_text);
    ...
    public void render(PdfObject object) {
        ...
        switch (object.getTypeImpl()) {
            ...
            case PdfObject.ARRAY:
                entriesTable.setModel(new PdfArrayTableModel((PdfArray) object));
                layout.show(this, TABLE);
                this.repaint();
                break;
            default:
                bottom_info_text.setText(object.toString());
                layout.show(this, TEXT);
                break;
        }
    }
