...
public class PdfObjectTreeNode extends IconTreeNode {
    ...
    public static com.lowagie.rups.view.itext.treenodes.PdfObjectTreeNode getInstance(PdfObject object) {
        ...
        return new com.lowagie.rups.view.itext.treenodes.PdfObjectTreeNode(object);
    }
     ...
     * @return a PdfObjectTreeNode
     */
    public static com.lowagie.rups.view.itext.treenodes.PdfObjectTreeNode getInstance(PdfObject object, int number) {
        com.lowagie.rups.view.itext.treenodes.PdfObjectTreeNode node = getInstance(object);
        node.number = number;
        return node;
    }
     ...
     * @return a PdfObjectTreeNode
     */
    public static com.lowagie.rups.view.itext.treenodes.PdfObjectTreeNode getInstance(PdfDictionary dict, PdfName key) {
        com.lowagie.rups.view.itext.treenodes.PdfObjectTreeNode node = getInstance(dict.get(key));
     ...
     */
    public com.lowagie.rups.view.itext.treenodes.PdfObjectTreeNode getAncestor() {
        if (isRecursive()) {
            com.lowagie.rups.view.itext.treenodes.PdfObjectTreeNode node = this;
            while (true) {
                node = (com.lowagie.rups.view.itext.treenodes.PdfObjectTreeNode) node.getParent();
